export const statusControlStyles = {
  ...
  deleteButton: "inline-flex min-h-10 min-w-20 items-center justify-center whitespace-nowrap rounded-xl bg-rose-100 px-3 py-2 text-sm font-bold text-rose-900 transition-colors hover:bg-rose-200",
  ...
  actionCell: "min-w-[23rem] px-4 py-4",
} as const;
