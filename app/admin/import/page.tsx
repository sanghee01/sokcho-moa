...
export default async function ImportCandidatePage() {
  ...
  return (
    <AdminShell email={admin.email}>
      ...
      <p className="mt-3 max-w-3xl leading-7 text-slate-600">확인할 수 없는 값은 추측하지 말고 `null`로 두세요. `sourceUrl`은 기관 대표 홈이 아닌 행사별 공식 원문, `officialUrl`은 공식 안내, `applicationUrl`은 직접 신청·예매 주소입니다. 이미지도 재사용 조건을 확인한 공식 원본만 넣을 수 있습니다. 등록 결과는 항상 검수 대기 상태이며, 운영자가 보완한 뒤에만 공개할 수 있습니다.</p>
